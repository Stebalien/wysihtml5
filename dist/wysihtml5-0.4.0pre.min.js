...
e,d)}}};
wysihtml5.dom.parse=function(){function a(c,e){var h=c.childNodes,f=h.length,l=b[c.nodeType],g=0,p,l=l&&l(c);if(!l)return null;for(g=0;g<f;g++)(p=a(h[g],e))&&l.appendChild(p);if(e&&!(l.nodeName.toLowerCase()!==d||l.childNodes.length&&l.attributes.length)){for(h=l.ownerDocument.createDocumentFragment();l.firstChild;)h.appendChild(l.firstChild);return h}return l}function c(a,b){b=b.toLowerCase();var c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;a:{try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken");break a}catch(e){if(a.complete&&
...
k=["html                 { height: 100%; }","body                 { height: 100%; padding: 1px 0 0 0; margin: -1px 0 0 0; }","body > p:first-child { margin-top: 0; }","._wysihtml5-temp     { display: none; }",a.browser.isGecko?"body.placeholder { color: graytext !important; }":"body.placeholder { color: #a9a9a9 !important; }","img:-moz-broken      { -moz-force-broken-image-icon: 1; height: 24px; width: 24px; }"],h=function(a){if(a.setActive)try{a.setActive()}catch(e){}else{var f=a.style,g=b.documentElement.scrollTop||
