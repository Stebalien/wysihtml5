...
window.rangy=function(){function a(a,b){var c=typeof a[b];return"function"==c||!("object"!=c||!a[b])||"unknown"==c}function c(a,b){return!("object"!=typeof a[b]||!a[b])}function b(a,b){return"undefined"!=typeof a[b]}function d(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&t(a,m)&&r(a,q)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);p.initialized=!0;p.supported=!1}function g(){if(!p.initialized){var b,d=!1,m=
!1;a(document,"createRange")&&(b=document.createRange(),t(b,l)&&r(b,h)&&(d=!0),b.detach());(b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange")&&(b=b.createTextRange(),e(b)&&(m=!0));d||m||f("Neither Range nor TextRange are implemented");p.initialized=!0;p.features={implementsDomRange:d,implementsTextRange:m};d=u.concat(v);m=0;for(b=d.length;m<b;++m)try{d[m](p)}catch(g){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
g)}}}function k(a){this.name=a;this.supported=this.initialized=!1}var h="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END".split(" "),l="setStart setStartBefore setStartAfter setEnd setEndBefore setEndAfter collapse selectNode selectNodeContents compareBoundaryPoints deleteContents extractContents cloneContents insertNode surroundContents cloneRange toString detach".split(" "),q="boundingHeight boundingLeft boundingTop boundingWidth htmlText text".split(" "),
...
null}};q.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+h(this.node)+":"+this.offset+")]"}};m.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};m.prototype.toString=function(){return this.message};a.dom={arrayContains:r,isHtmlNamespace:function(a){var b;return"undefined"==typeof a.namespaceURI||null===(b=a.namespaceURI)||
"http://www.w3.org/1999/xhtml"==b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:b,getNodeLength:function(a){var b;return f(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:d,isAncestorOf:function(a,b,c){for(b=c?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:e,isCharacterDataNode:f,insertAfter:g,splitDataNode:function(a,b){var c=a.cloneNode(!1);c.deleteData(0,b);a.deleteData(b,a.length-b);g(c,a);return c},getDocument:k,
...
if("undefined"!=typeof a.contentWindow)return a.contentWindow.document;throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return t.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,c,h,l){var f;if(a==h)return c===l?0:c<l?-1:1;if(f=e(h,a,!0))return c<=b(f)?-1:1;if(f=e(a,h,!0))return b(f)<l?-1:1;c=d(a,h);a=a===c?c:e(a,c,!0);h=h===c?c:e(h,c,!0);if(a===
h)throw Error("comparePoints got to case 4 and childA and childB are the same!");for(c=c.firstChild;c;){if(c===a)return-1;if(c===h)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:h,fragmentFromNodeChildren:function(a){for(var b=k(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new l(a)},DomPosition:q};a.DOMException=m});
rangy.createModule("DomRange",function(a){function c(a,b){return 3!=a.nodeType&&(n.isAncestorOf(a,b.startContainer,!0)||n.isAncestorOf(a,b.endContainer,!0))}function b(a){return n.getDocument(a.startContainer)}function d(a,b,c){if(b=a._listeners[b])for(var d=0,h=b.length;d<h;++d)b[d].call(a,{target:a,args:c})}function e(a){return new I(a.parentNode,n.getNodeIndex(a))}function f(a){return new I(a.parentNode,n.getNodeIndex(a)+1)}function g(a,b,c){var d=11==a.nodeType?a.firstChild:a;n.isCharacterDataNode(b)?
c==b.length?n.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:n.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function k(a){for(var c,d,h=b(a.range).createDocumentFragment();d=a.next();){c=a.isPartiallySelectedSubtree();d=d.cloneNode(!c);c&&(c=a.getSubtreeIterator(),d.appendChild(k(c)),c.detach(!0));if(10==d.nodeType)throw new F("HIERARCHY_REQUEST_ERR");h.appendChild(d)}return h}function h(a,b,c){var d,e;for(c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
b(d)){c.stop=!0;break}else{if(d=a.getSubtreeIterator(),h(d,b,c),d.detach(!0),c.stop)break}else for(d=n.createIterator(d);e=d.next();)if(!1===b(e)){c.stop=!0;return}}function l(a){for(var b;a.next();)a.isPartiallySelectedSubtree()?(b=a.getSubtreeIterator(),l(b),b.detach(!0)):a.remove()}function q(a){for(var c,d=b(a.range).createDocumentFragment(),h;c=a.next();){a.isPartiallySelectedSubtree()?(c=c.cloneNode(!1),h=a.getSubtreeIterator(),c.appendChild(q(h)),h.detach(!0)):a.remove();if(10==c.nodeType)throw new F("HIERARCHY_REQUEST_ERR");
d.appendChild(c)}return d}function m(a,b,c){var d=!(!b||!b.length),e,l=!!c;d&&(e=RegExp("^("+b.join("|")+")$"));var f=[];h(new s(a,!1),function(a){d&&!e.test(a.nodeType)||l&&!c(a)||f.push(a)});return f}function t(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+n.inspectNode(a.startContainer)+":"+a.startOffset+", "+n.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function s(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;this.so=
...
this.codeName=a;this.message="RangeException: "+this.codeName}function p(a,b,c){this.nodes=m(a,b,c);this._next=this.nodes[0];this._position=0}function v(a){return function(b,c){for(var d,h=c?b:b.parentNode;h;){d=h.nodeType;if(n.arrayContains(a,d))return h;h=h.parentNode}return null}}function u(a,b){if(da(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function w(a){if(!a.startContainer)throw new F("INVALID_STATE_ERR");}function z(a,b){if(!n.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
...
function G(a){H(a);H(a.prototype)}function N(a,b){return function(){x(this);var c=this.startContainer,d=this.startOffset,e=this.commonAncestorContainer,l=new s(this,!0);c!==e&&(c=n.getClosestAncestorIn(c,e,!0),d=f(c),c=d.node,d=d.offset);h(l,E);l.reset();e=a(l);l.detach();b(this,c,d,c,d);return e}}function P(b,d,h){function m(a,b){return function(c){w(this);z(c,J);z(Q(c),L);c=(a?e:f)(c);(b?g:T)(this,c.node,c.offset)}}function g(a,b,c){var h=a.endContainer,e=a.endOffset;if(b!==a.startContainer||c!==
a.startOffset){if(Q(b)!=Q(h)||1==n.comparePoints(b,c,h,e))h=b,e=c;d(a,b,c,h,e)}}function T(a,b,c){var h=a.startContainer,e=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(Q(b)!=Q(h)||-1==n.comparePoints(b,c,h,e))h=b,e=c;d(a,h,e,b,c)}}b.prototype=new M;a.util.extend(b.prototype,{setStart:function(a,b){w(this);u(a,!0);D(a,b);g(this,a,b)},setEnd:function(a,b){w(this);u(a,!0);D(a,b);T(this,a,b)},setStartBefore:m(!0,!0),setStartAfter:m(!1,!0),setEndBefore:m(!0,!1),setEndAfter:m(!1,!1),collapse:function(a){x(this);
...
c(a._first,this)||a._last&&c(a._last,this);a.detach();return!b},detach:function(){h(this)},splitBoundaries:function(){x(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,h=this.endOffset,e=a===c;n.isCharacterDataNode(c)&&0<h&&h<c.length&&n.splitDataNode(c,h);n.isCharacterDataNode(a)&&(0<b&&b<a.length)&&(a=n.splitDataNode(a,b),e?(h-=b,c=a):c==a.parentNode&&h>=n.getNodeIndex(a)&&h++,b=0);d(this,a,b,c,h)},normalizeBoundaries:function(){x(this);var a=this.startContainer,b=this.startOffset,
c=this.endContainer,h=this.endOffset,e=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,h=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},l=function(d){var e=d.previousSibling;if(e&&e.nodeType==d.nodeType){a=d;var l=d.length;b=e.length;d.insertData(0,e.data);e.parentNode.removeChild(e);a==c?(h+=b,c=a):c==d.parentNode&&(e=n.getNodeIndex(d),h==e?(c=d,h=l):h>e&&h--)}},f=!0;n.isCharacterDataNode(c)?c.length==h&&e(c):(0<h&&(f=c.childNodes[h-1])&&n.isCharacterDataNode(f)&&e(f),
f=!this.collapsed);f?n.isCharacterDataNode(a)?0==b&&l(a):b<a.childNodes.length&&(e=a.childNodes[b])&&n.isCharacterDataNode(e)&&l(e):(a=c,b=h);d(this,a,b,c,h)},collapseToPoint:function(a,b){w(this);u(a,!0);D(a,b);a===this.startContainer&&b===this.startOffset&&a===this.endContainer&&b===this.endOffset||d(this,a,b,a,b)}});G(b)}function O(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:n.getCommonAncestor(a.startContainer,
a.endContainer)}function R(a,b,c,h,e){var l=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==h||a.endOffset!==e;a.startContainer=b;a.startOffset=c;a.endContainer=h;a.endOffset=e;O(a);d(a,"boundarychange",{startMoved:l,endMoved:f})}function A(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};O(this)}a.requireModules(["DomUtil"]);var n=a.dom,I=n.DomPosition,F=a.DOMException;s.prototype={_current:null,_next:null,_first:null,
...
b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){x(this);B(this.startContainer,b.startContainer);var c=a==Z||a==U?"start":"end",d=a==Y||a==U?"start":"end";return n.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){x(this);z(a,K);E(this.startContainer);if(n.isAncestorOf(a,this.startContainer,!0))throw new F("HIERARCHY_REQUEST_ERR");this.setStartBefore(g(a,this.startContainer,this.startOffset))},cloneContents:function(){x(this);
...
rangy.createModule("WrappedRange",function(a){function c(a,b,c,d){var g=a.duplicate();g.collapse(c);var k=g.parentElement();e.isAncestorOf(b,k,!0)||(k=b);if(!k.canHaveHTML)return new f(k.parentNode,e.getNodeIndex(k));b=e.getDocument(k).createElement("span");var r,p=c?"StartToStart":"StartToEnd";do k.insertBefore(b,b.previousSibling),g.moveToElementText(b);while(0<(r=g.compareEndPoints(p,a))&&b.previousSibling);p=b.nextSibling;if(-1==r&&p&&e.isCharacterDataNode(p)){g.setEndPoint(c?"EndToStart":"EndToEnd",
a);if(/[\r\n]/.test(p.data))for(k=g.duplicate(),c=k.text.replace(/\r\n/g,"\r").length,c=k.moveStart("character",c);-1==k.compareEndPoints("StartToEnd",k);)c++,k.moveStart("character",1);else c=g.text.length;k=new f(p,c)}else p=(d||!c)&&b.previousSibling,k=(c=(d||c)&&b.nextSibling)&&e.isCharacterDataNode(c)?new f(c,0):p&&e.isCharacterDataNode(p)?new f(p,p.length):new f(k,e.getNodeIndex(b));b.parentNode.removeChild(b);return k}function b(a,b){var c,d,f=a.offset,g=e.getDocument(a.node),k=g.body.createTextRange(),
p=e.isCharacterDataNode(a.node);p?(c=a.node,d=c.parentNode):(c=a.node.childNodes,c=f<c.length?c[f]:null,d=a.node);g=g.createElement("span");g.innerHTML="&#feff;";c?d.insertBefore(g,c):d.appendChild(g);k.moveToElementText(g);k.collapse(!b);d.removeChild(g);if(p)k[b?"moveStart":"moveEnd"]("character",f);return k}a.requireModules(["DomUtil","DomRange"]);var d,e=a.dom,f=e.DomPosition,g=a.DomRange;if(a.features.implementsDomRange&&(!a.features.implementsTextRange||!a.config.preferTextRange))(function(){function b(a){for(var c=
f.length,d;c--;)d=f[c],a[d]=a.nativeRange[d]}var c,f=g.rangeProperties,m,k;d=function(a){if(!a)throw Error("Range must be specified");this.nativeRange=a;b(this)};g.createPrototypeRange(d,function(a,b,c,d,h){var e=a.endContainer!==d||a.endOffset!=h;if(a.startContainer!==b||a.startOffset!=c||e)a.setEnd(d,h),a.setStart(b,c)},function(a){a.nativeRange.detach();a.detached=!0;for(var b=f.length,c;b--;)c=f[b],a[c]=null});c=d.prototype;c.selectNode=function(a){this.nativeRange.selectNode(a);b(this)};c.deleteContents=
...
r.startContainer==s&&r.endContainer==s&&0==r.startOffset&&r.endOffset==s.length?function(a){this.nativeRange.selectNodeContents(a);b(this)}:function(a){this.setStart(a,0);this.setEnd(a,g.getEndOffset(a))};r.selectNodeContents(s);r.setEnd(s,3);m=document.createRange();m.selectNodeContents(s);m.setEnd(s,4);m.setStart(s,2);c.compareBoundaryPoints=-1==r.compareBoundaryPoints(r.START_TO_END,m)&1==r.compareBoundaryPoints(r.END_TO_START,m)?function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:
...
a;this.refresh()};d.prototype=new g(document);d.prototype.refresh=function(){var a,b,d=this.textRange;a=d.parentElement();var f=d.duplicate();f.collapse(!0);b=f.parentElement();f=d.duplicate();f.collapse(!1);d=f.parentElement();b=b==d?b:e.getCommonAncestor(b,d);b=b==a?b:e.getCommonAncestor(a,b);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?b=a=c(this.textRange,b,!0,!0):(a=c(this.textRange,b,!0,!1),b=c(this.textRange,b,!1,!1));this.setStart(a.node,a.offset);this.setEnd(b.node,b.offset)};
g.copyComparisonConstants(d);var k=function(){return this}();"undefined"==typeof k.Range&&(k.Range=d);a.createNativeRange=function(a){a=a||document;return a.body.createTextRange()}}a.features.implementsTextRange&&(d.rangeToTextRange=function(a){if(a.collapsed)return b(new f(a.startContainer,a.startOffset),!0);var c=b(new f(a.startContainer,a.startOffset),!0),d=b(new f(a.endContainer,a.endOffset),!1);a=e.getDocument(a.startContainer).body.createTextRange();a.setEndPoint("StartToStart",c);a.setEndPoint("EndToEnd",
d);return a});d.prototype.getName=function(){return"WrappedRange"};a.WrappedRange=d;a.createRange=function(b){b=b||document;return new d(a.createNativeRange(b))};a.createRangyRange=function(a){a=a||document;return new g(a)};a.createIframeRange=function(b){return a.createRange(e.getIframeDocument(b))};a.createIframeRangyRange=function(b){return a.createRangyRange(e.getIframeDocument(b))};a.addCreateMissingNativeApiListener(function(b){b=b.document;"undefined"==typeof b.createRange&&(b.createRange=
function(){return a.createRange(this)});b=b=null})});
rangy.createModule("WrappedSelection",function(a,c){function b(a){return(a||window).getSelection()}function d(a){return(a||window).document.selection}function e(a,b,c){var d=c?"end":"start";c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function f(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function g(b){var c;b instanceof u?(c=b._selectionNativeRange,
...
!0}else c=!1;if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function h(a,b){var c=new w(b);a._ranges=[c];e(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)f(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)h(b,c);else{b.rangeCount=c.length;for(var d,l=p.getDocument(c.item(0)),m=0;m<b.rangeCount;++m)d=a.createRange(l),d.selectNode(c.item(m)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function q(a,b){for(var c=a.docSelection.createRange(),d=k(b),e=p.getDocument(c.item(0)),e=p.getBody(e).createControlRange(),h=0,f=c.length;h<f;++h)e.add(c.item(h));try{e.add(d)}catch(m){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}e.select();l(a)}function m(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function t(a,b){for(var c=p.getDocument(b[0].startContainer),c=p.getBody(c).createControlRange(),d=0,e;d<rangeCount;++d){e=k(b[d]);try{c.add(e)}catch(h){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}c.select();l(a)}function s(a,b){if(a.anchorNode&&p.getDocument(a.anchorNode)!==p.getDocument(b))throw new z("WRONG_DOCUMENT_ERR");}function r(a){var b=[],c=new D(a.anchorNode,a.anchorOffset),
d=new D(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,f=a.rangeCount;h<f;++h)b[h]=u.inspect(a.getRangeAt(h));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var p=a.dom,v=a.util,u=a.DomRange,w=a.WrappedRange,z=a.DOMException,D=p.DomPosition,B,E,y=a.util.isHostMethod(window,"getSelection"),
...
f(this)};var F=function(b,c){var d=u.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};n.addRange=P?function(b,c){if(A&&C&&"Control"==this.docSelection.type)q(this,b);else if(c&&N)F(this,b);else{var d;O?d=this.rangeCount:(this.removeAllRanges(),d=0);this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==d+1?(a.config.checkSelectionRanges&&
(d=I(this.nativeSelection,this.rangeCount-1))&&!u.rangesEqual(d,b)&&(b=new w(d)),this._ranges[this.rangeCount-1]=b,e(this,b,K(this.nativeSelection)),this.isCollapsed=E(this)):this.refresh()}}:function(a,b){b&&N?F(this,a):(this.nativeSelection.addRange(g(a)),this.refresh())};n.setRanges=function(a){if(A&&1<a.length)t(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(v.isHostMethod(y,"empty")&&v.isHostMethod(M,"select")&&A&&x)n.removeAllRanges=function(){try{if(this.docSelection.empty(),
...
return!0}};var L=function(a,b){var c=a.getAllRanges(),d=!1;a.removeAllRanges();for(var e=0,h=c.length;e<h;++e)d||b!==c[e]?a.addRange(c[e]):d=!0;a.rangeCount||f(a)};n.removeRange=A?function(a){if("Control"==this.docSelection.type){var b=this.docSelection.createRange();a=k(a);for(var c=p.getDocument(b.item(0)),c=p.getBody(c).createControlRange(),d,e=!1,h=0,f=b.length;h<f;++h)d=b.item(h),d!==a||e?c.add(b.item(h)):e=!0;c.select();l(this)}else L(this,a)}:function(a){L(this,a)};var K;!x&&G&&a.features.implementsDomRange?
...
a=this.isIos()&&5>+(/ipad|iphone|ipod/.test(a)&&a.match(/ os (\d+).+? like mac os x/)||[void 0,0])[1]||this.isAndroid()&&4>+(a.match(/android (\d+)/)||[void 0,0])[1]||-1!==a.indexOf("opera mobi")||-1!==a.indexOf("hpwos/");return b&&d&&e&&!a},isTouchDevice:function(){return this.supportsEvent("touchmove")},isIos:function(){return/ipad|iphone|ipod/i.test(this.USER_AGENT)},isAndroid:function(){return-1!==this.USER_AGENT.indexOf("Android")},supportsSandboxedIframes:function(){return b},throwsMixedContentWarningWhenIframeSrcIsEmpty:function(){return!("querySelector"in
...
hasProblemsSettingCaretAfterImg:function(){return b},hasUndoInContextMenu:function(){return d||f||g},hasInsertNodeIssue:function(){return g},hasIframeFocusIssue:function(){return b},createsNestedInvalidMarkupAfterPaste:function(){return e},hasMutationObserverSupport:function(){return window.hasOwnProperty("MutationObserver")},hasMutationEventSupport:function(){return window.hasOwnProperty("MutationEvent")}}}();
...
(function(a){function c(a){return a.replace(e,function(a,b){var c=(b.match(f)||[])[1]||"",d=k[c];b=b.replace(f,"");b.split(d).length>b.split(c).length&&(b+=c,c="");var e=d=b;b.length>g&&(e=e.substr(0,g)+"...");"www."===d.substr(0,4)&&(d="http://"+d);return'<a href="'+d+'">'+e+"</a>"+c})}function b(h){if(!d.contains(h.nodeName))if(h.nodeType===a.TEXT_NODE&&h.data.match(e)){var f=h.parentNode,g=a.lang.string(h.data).escapeHTML(),m;m=f.ownerDocument;var k=m._wysihtml5_tempElement;k||(k=m._wysihtml5_tempElement=
m.createElement("div"));m=k;m.innerHTML="<span></span>"+c(g);for(m.removeChild(m.firstChild);m.firstChild;)f.insertBefore(m.firstChild,h);f.removeChild(h)}else{f=a.lang.array(h.childNodes).get();g=f.length;for(m=0;m<g;m++)b(f[m]);return h}}var d=a.lang.array("CODE PRE A SCRIPT HEAD TITLE STYLE".split(" ")),e=/((https?:\/\/|www\.)[^\s<]{3,})/gi,f=/([^\w\/\-](,?))$/i,g=100,k={")":"(","]":"[","}":"{"};a.dom.autoLink=function(a){var c;a:{c=a;for(var e;c.parentNode;){c=c.parentNode;e=c.nodeName;if(d.contains(e)){c=
...
wysihtml5.dom.convertToList=function(){function a(a,b){var d=a.createElement("li");b.appendChild(d);return d}return function(c,b){if("UL"===c.nodeName||"OL"===c.nodeName||"MENU"===c.nodeName)return c;var d=c.ownerDocument,e=d.createElement(b),f=c.querySelectorAll("br"),g=f.length,k,h,l,q,m;for(m=0;m<g;m++)for(k=f[m];(h=k.parentNode)&&h!==c&&h.lastChild===k;){if("block"===wysihtml5.dom.getStyle("display").from(h)){h.removeChild(k);break}wysihtml5.dom.insert(k).after(k.parentNode)}f=wysihtml5.lang.array(c.childNodes).get();
g=f.length;for(m=0;m<g;m++)q=q||a(d,e),k=f[m],h="block"===wysihtml5.dom.getStyle("display").from(k),l="BR"===k.nodeName,h?(q=q.firstChild?a(d,e):q,q.appendChild(k),q=null):l?q=q.firstChild?null:q:q.appendChild(k);0===f.length&&a(d,e);c.parentNode.replaceChild(e,c);return e}}();wysihtml5.dom.copyAttributes=function(a){return{from:function(c){return{to:function(b){for(var d,e=0,f=a.length;e<f;e++)d=a[e],"undefined"!==typeof c[d]&&""!==c[d]&&(b[d]=c[d]);return{andTo:arguments.callee}}}}}};
...
wysihtml5.dom.observe=function(a,c,b){c="string"===typeof c?[c]:c;for(var d,e,f=0,g=c.length;f<g;f++)e=c[f],a.addEventListener?a.addEventListener(e,b,!1):(d=function(c){"target"in c||(c.target=c.srcElement);c.preventDefault=c.preventDefault||function(){this.returnValue=!1};c.stopPropagation=c.stopPropagation||function(){this.cancelBubble=!0};b.call(a,c)},a.attachEvent("on"+e,d));return{stop:function(){for(var e,h=0,f=c.length;h<f;h++)e=c[h],a.removeEventListener?a.removeEventListener(e,b,!1):a.detachEvent("on"+
e,d)}}};
wysihtml5.dom.parse=function(){function a(c,e){var h=c.childNodes,f=h.length,g=b[c.nodeType],l=0,k,g=g&&g(c);if(!g)return null;for(l=0;l<f;l++)(k=a(h[l],e))&&g.appendChild(k);if(e&&!(g.nodeName.toLowerCase()!==d||g.childNodes.length&&g.attributes.length)){for(h=g.ownerDocument.createDocumentFragment();g.firstChild;)h.appendChild(g.firstChild);return h}return g}function c(a,b){b=b.toLowerCase();var c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;a:{try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken");break a}catch(e){if(a.complete&&
...
!1,k):(k=h.createContextualFragment(k),h.insertNode(k));try{b(h.startContainer,h.endContainer)}catch(q){setTimeout(function(){throw q;},0)}(h=this.doc.querySelector("._wysihtml5-temp-placeholder"))?(k=rangy.createRange(this.doc),l=h.nextSibling,a.browser.hasInsertNodeIssue()&&l&&"BR"===l.nodeName?(l=this.doc.createTextNode(a.INVISIBLE_SPACE),c.insert(l).after(h),k.setStartBefore(l),k.setEndBefore(l)):(k.selectNode(h),k.deleteContents()),this.setSelection(k)):e.focus();d&&(e.scrollTop=f,e.scrollLeft=
g);try{h.parentNode.removeChild(h)}catch(m){}}else b(e,e)},executeAndRestoreSimple:function(a){var c,e,f=this.getRange(),g=this.doc.body,k;if(f){c=f.getNodes([3]);g=c[0]||f.startContainer;k=c[c.length-1]||f.endContainer;c=g===f.startContainer?f.startOffset:0;e=k===f.endContainer?f.endOffset:k.length;try{a(f.startContainer,f.endContainer)}catch(h){setTimeout(function(){throw h;},0)}a=rangy.createRange(this.doc);try{a.setStart(g,c)}catch(l){}try{a.setEnd(k,e)}catch(q){}try{this.setSelection(a)}catch(m){}}else a(g,
...
b.tagName.toLowerCase())&&d)return b;b=b.parentNode}return!1},postApply:function(a,b){for(var c=a[0],d=a[a.length-1],f=[],g,k=c,p=d,v=0,u=d.length,w,z,D=0,B=a.length;D<B;++D)w=a[D],(z=this.getAdjacentMergeableTextNode(w.parentNode,!1))?(g||(g=new e(z),f.push(g)),g.textNodes.push(w),w===c&&(k=g.firstTextNode,v=k.length),w===d&&(p=g.firstTextNode,u=g.getLength())):g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),g.textNodes.push(c);if(f.length){D=0;for(B=f.length;D<
...
(function(a){function c(c,g){var k=c.doc,h="_wysihtml5-temp-"+ +new Date,l=0,q,m,t;a.commands.formatInline.exec(c,b,d,h,/non-matching-class/g);q=k.querySelectorAll(d+"."+h);for(h=q.length;l<h;l++)for(t in m=q[l],m.removeAttribute("class"),g)m.setAttribute(t,g[t]);l=m;1===h&&(t=e.getTextContent(m),h=!!m.querySelector("*"),t=""===t||t===a.INVISIBLE_SPACE,!h&&t&&(e.setTextContent(m,g.text||m.href),k=k.createTextNode(" "),c.selection.setAfter(m),e.insert(k).after(m),l=k));c.selection.setAfter(l)}var b,
...
l,q,m,t){var s=h.doc,r=this.state(h,l,q,m,t),p=h.config.useLineBreaks,v=p?"DIV":"P",u;q="string"===typeof q?q.toUpperCase():q;if(r)h.selection.executeAndRestoreSimple(function(){t&&(r.className=r.className.replace(t,""));if(a.lang.string(r.className).trim()||!p&&"P"!==q)g.renameElement(r,"P"===q?"DIV":v);else{var e=r,f=e.ownerDocument,h=b(e),k=c(e);h&&!d(h)&&e.parentNode.insertBefore(f.createElement("br"),h);k&&!d(k)&&e.parentNode.insertBefore(f.createElement("br"),e);g.replaceWithChildNodes(r)}});
else{if(null===q||a.lang.array(k).contains(q))if(u=h.selection.getSelectedNode(),r=g.getParentElement(u,{nodeName:k})){h.selection.executeAndRestore(function(){q&&(r=g.renameElement(r,q));if(m){var a=r;a.className?(a.className=a.className.replace(t,""),a.className+=" "+m):a.className=m}});return}h.commands.support(l)?e(s,l,q||v,m):(r=s.createElement(q||v),m&&(r.className=m),f(h,r))}},state:function(a,b,c,d,e){c="string"===typeof c?c.toUpperCase():c;a=a.selection.getSelectedNode();return g.getParentElement(a,
{nodeName:c,className:d,classRegExp:e})}}})(wysihtml5);
(function(a){function c(c,f,g){var k=c+":"+f;if(!d[k]){var h=d,l=a.selection.HTMLApplier,q=b[c];c=q?[c.toLowerCase(),q.toLowerCase()]:[c.toLowerCase()];h[k]=new l(c,f,g,!0)}return d[k]}var b={strong:"b",em:"i",b:"strong",i:"em"},d={};a.commands.formatInline={exec:function(a,b,d,k,h){b=a.selection.getRange();if(!b)return!1;c(d,k,h).toggleRange(b);a.selection.setSelection(b)},state:function(d,f,g,k,h){f=d.doc;var l=b[g]||g;return!a.dom.hasElementWithTagName(f,g)&&!a.dom.hasElementWithTagName(f,l)||
...
a}catch(c){this.element.innerText=a}},prependValue:function(a,b){b&&(a=this.parent.parse(a));var c=this.doc.createElement("div");c.innerHTML=a;for(var g=c.childNodes.length-1;0<=g;g--)this.element.insertBefore(c.childNodes[g],this.element.firstChild)},appendValue:function(a,b){b&&(a=this.parent.parse(a));var c=this.doc.createElement("div");c.innerHTML=a;for(var g=0;g<c.childNodes.length;g++)this.element.appendChild(c.childNodes[g])},replaceValue:function(a,b){var c=this.element;this.selection.executeAndRestore(function(){c.innerHTML=
...
v;this.focusStylesHost=e.cloneNode(!1);this.blurStylesHost=e.cloneNode(!1);this.disabledStylesHost=e.cloneNode(!1);t&&m.removeAttribute("placeholder");m===q&&m.blur();m.disabled=!1;m.style.display=v="none";if(m.getAttribute("rows")&&"auto"===c.getStyle("height").from(m)||m.getAttribute("cols")&&"auto"===c.getStyle("width").from(m))m.style.display=v=r;c.copyStyles(g).from(m).to(this.iframe).andTo(this.blurStylesHost);c.copyStyles(f).from(m).to(this.element).andTo(this.blurStylesHost);c.insertCSS(k).into(this.element.ownerDocument);
m.disabled=!0;c.copyStyles(g).from(m).to(this.disabledStylesHost);c.copyStyles(f).from(m).to(this.disabledStylesHost);m.disabled=p;m.style.display=r;h(m);m.style.display=v;c.copyStyles(g).from(m).to(this.focusStylesHost);c.copyStyles(f).from(m).to(this.focusStylesHost);m.style.display=r;c.copyStyles(["display"]).from(m).to(this.iframe);var u=a.lang.array(g).without(["display"]);q?q.focus():m.blur();t&&m.setAttribute("placeholder",s);this.parent.on("focus:composer",function(){c.copyStyles(u).from(d.focusStylesHost).to(d.iframe);
...
(function(a){var c=a.dom,b=a.browser,d={66:"bold",73:"italic",85:"underline"};a.views.Composer.prototype.observe=function(){var e=this,f=this.getValue(),g=this.sandbox.getIframe(),k=this.element,h=b.supportsEventsInIframeCorrectly()?k:this.sandbox.getWindow();if(a.browser.hasMutationObserverSupport())(new MutationObserver(function(a){for(var b=0;b<a.length;b++){var c=a[b];if("childList"===c.type)for(var c=c.removedNodes,d=c.length,f=0;f<d;f++){var h=c[f];if(h===g||h.contains(g)){e.parent.fire("destroy:composer");return}}}})).observe(document.body,
{childList:!0,subtree:!0});else if(a.browser.hasMutationEventSupport())c.observe(g,"DOMNodeRemovedFromDocument",function(){e.parent.fire("destroy:composer")});else var l=setInterval(function(){c.contains(document.documentElement,g)||(clearInterval(l),e.parent.fire("destroy:composer"))},250);c.observe(h,"focus",function(){e.parent.fire("focus").fire("focus:composer");setTimeout(function(){f=e.getValue()},0)});c.observe(h,"blur",function(){f!==e.getValue()&&e.parent.fire("change").fire("change:composer");
...
0)})},_updateLinkStates:function(){var b=this.commandMapping,d=this.actionMapping,e,f,g;for(e in b)g=b[e],this.commandsDisabled?(f=!1,c.removeClass(g.link,"wysihtml5-command-active"),g.group&&c.removeClass(g.group,"wysihtml5-command-active"),g.dialog&&g.dialog.hide()):(f=this.composer.commands.state(g.name,g.value),a.lang.object(f).isArray()&&(f=1===f.length?f[0]:!0),c.removeClass(g.link,"wysihtml5-command-disabled"),g.group&&c.removeClass(g.group,"wysihtml5-command-disabled")),g.state!==f&&((g.state=
